...
require_once __DIR__ . '/../../dte/dte_sietelsa/src/config/session.php';
...
<html lang="es">
  ...
  <body>
    <div class="container-scroller">
      <?php include __DIR__ . '/../../dte/dte_sietelsa/src/partials/_navbar.php'; ?>
      <div class="container-fluid page-body-wrapper">
        <?php include __DIR__ . '/../../dte/dte_sietelsa/src/partials/_sidebar.php'; ?>
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <?php include __DIR__ . '/../../dte/dte_sietelsa/src/partials/_footer.php'; ?>
          </div>
        </div>
      </div>
    </div>
