              ...
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form class="pt-3">
                  ...
                  <div class="mt-3 d-grid gap-2">
                    <a class="btn btn-block btn-primary btn-lg fw-medium auth-form-btn" href="../dashboard_admin/index.php">SIGN IN</a>
                  </div>
                  ...
                  <div class="text-center mt-4 fw-light"> Don't have an account? <a href="../dashboard_admin/pages/samples/register.php" class="text-primary">Create</a>
                  </div>
                </form>
              </div>
            </div>
